 ...
 */
export const formatTooltipData = (countryName, coinSymbol, value) => {
  ...
  return `
    <div style="
      ...
      pointer-events: none;
    ">
      <div style="font-size: 11px; text-transform: uppercase; color: #ffd700; font-weight: 800; letter-spacing: 0.8px; margin-bottom: 6px; border-bottom: 1px solid rgba(255,255,255,0.08); padding-bottom: 4px;">
        📍 ${countryName}
      </div>
      <div style="display: flex; align-items: center; justify-content: space-between; margin-top: 8px;">
        <span style="font-size: 13px; color: rgba(255,255,255,0.75);">Dominância ${coinSymbol}:</span>
        <span style="font-size: 14px; font-weight: 700; color: #ffd700; font-family: 'Share Tech Mono', monospace;">
          ${value}%
        </span>
      </div>
      <div style="margin-top: 10px; font-size: 11px; color: #fff; font-weight: 500; display: flex; align-items: center; gap: 4px;">
        ${sentiment}
      </div>
    </div>
  `;
