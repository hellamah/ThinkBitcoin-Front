...
// Cor da moeda como TEXTO: no tema claro precisa escurecer. Preenchimentos,
// bordas e séries de gráfico continuam com corDaMoeda().
export const tintaDaMoeda = (moeda, escuro) =>
  (escuro ? corDaMoeda(moeda) : escurecer(corDaMoeda(moeda), 0.55))
